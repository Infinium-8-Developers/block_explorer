...
GRANT EXECUTE ON PROCEDURE purge() TO infinium;

GRANT EXECUTE ON PROCEDURE purgeaboveheight(p_height integer) TO infinium;

GRANT EXECUTE ON PROCEDURE update_statistics(p_startheight integer) TO infinium;

GRANT ALL ON TABLE aliases TO infinium;

GRANT ALL ON TABLE alt_blocks TO infinium;

GRANT ALL ON TABLE blocks TO infinium;

GRANT ALL ON TABLE charts TO infinium;

GRANT ALL ON TABLE out_info TO infinium;

GRANT ALL ON TABLE pool TO infinium;

GRANT ALL ON TABLE transactions TO infinium;
